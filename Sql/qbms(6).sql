...
CREATE TABLE `examination`  (
  `examination_id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `course_id` int(0) NOT NULL,
  `examination_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `examination_content` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `examination` VALUES (1, 1, '2021-12-25 18:05:59', '考试内容');
INSERT INTO `examination` VALUES (2, 2, '2021-12-25 19:33:55', 'asd');
...
CREATE TABLE `examination_question`  (
  `examination_id` int(0) UNSIGNED NOT NULL COMMENT '试卷id',
  `question_id` int(0) NOT NULL COMMENT '题目id',
  PRIMARY KEY (`examination_id`, `question_id`) USING BTREE,
  INDEX `Qid`(`question_id`) USING BTREE,
  CONSTRAINT `Eid` FOREIGN KEY (`examination_id`) REFERENCES `examination` (`examination_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `Qid` FOREIGN KEY (`question_id`) REFERENCES `question` (`question_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of examination_question
-- ----------------------------
INSERT INTO `examination_question` VALUES (1, 1);
INSERT INTO `examination_question` VALUES (1, 2);
...
CREATE TABLE `question`  (
  ...
  `question_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Records of question
-- ----------------------------
INSERT INTO `question` VALUES (1, 2, '2021-12-25 18:40:44', 1, 101);
INSERT INTO `question` VALUES (2, 3, '2021-12-25 19:48:32', 1, 102);
INSERT INTO `question` VALUES (3, 2, '2021-12-25 18:40:44', 3, 101);
INSERT INTO `question` VALUES (4, 2, '2021-12-25 18:40:44', 1, 101);
INSERT INTO `question` VALUES (5, 2, '2021-12-25 18:40:44', 3, 101);
INSERT INTO `question` VALUES (6, 2, '2021-12-25 18:40:44', 3, 102);
INSERT INTO `question` VALUES (7, 2, '2021-12-25 18:40:44', 4, 101);
INSERT INTO `question` VALUES (8, 2, '2021-12-25 18:40:44', 1, 101);
INSERT INTO `question` VALUES (9, 2, '2021-12-25 18:40:44', 4, 105);
INSERT INTO `question` VALUES (10, 2, '2021-12-25 18:40:44', 4, 106);
INSERT INTO `question` VALUES (11, 2, '2021-12-25 18:40:44', 1, 101);
INSERT INTO `question` VALUES (12, 2, '2021-12-25 18:40:44', 1, 101);
INSERT INTO `question` VALUES (13, 2, '2021-12-25 18:40:44', 1, 101);
INSERT INTO `question` VALUES (14, 2, '2021-12-25 18:40:44', 4, 101);
INSERT INTO `question` VALUES (15, 2, '2021-12-25 18:40:44', 4, 101);
INSERT INTO `question` VALUES (16, 2, '2021-12-25 18:40:44', 4, 101);
INSERT INTO `question` VALUES (17, 2, '2021-12-25 18:40:44', 3, 101);
INSERT INTO `question` VALUES (18, 2, '2021-12-25 18:40:44', 3, 101);
INSERT INTO `question` VALUES (19, 2, '2021-12-25 18:40:44', 3, 101);
INSERT INTO `question` VALUES (20, 2, '2021-12-25 18:40:44', 3, 102);
INSERT INTO `question` VALUES (21, 2, '2021-12-25 18:40:44', 1, 101);
INSERT INTO `question` VALUES (22, 2, '2021-12-25 18:40:44', 1, 102);
INSERT INTO `question` VALUES (23, 2, '2021-12-25 18:40:44', 1, 103);
INSERT INTO `question` VALUES (24, 2, '2021-12-25 18:40:44', 1, 104);
INSERT INTO `question` VALUES (25, 2, '2021-12-25 18:40:44', 3, 104);
INSERT INTO `question` VALUES (26, 2, '2021-12-25 18:40:44', 4, 104);
INSERT INTO `question` VALUES (27, 2, '2021-12-25 18:40:44', 1, 104);
INSERT INTO `question` VALUES (28, 2, '2021-12-25 18:40:44', 3, 106);
INSERT INTO `question` VALUES (29, 2, '2021-12-25 18:40:44', 1, 105);
INSERT INTO `question` VALUES (30, 2, '2021-12-25 18:40:44', 1, 108);
INSERT INTO `question` VALUES (31, 2, '2021-12-25 18:40:44', 3, 105);
INSERT INTO `question` VALUES (32, 2, '2021-12-25 18:40:44', 3, 107);
INSERT INTO `question` VALUES (33, 2, '2021-12-25 18:40:44', 3, 108);
...
-- ----------------------------
-- View structure for asdf
-- ----------------------------
DROP VIEW IF EXISTS `asdf`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `asdf` AS select distinct `course`.`course_name` AS `course_name`,`question_type`.`question_name` AS `question_name` from (((`course` join `chapter` on((`chapter`.`course_id` = `course`.`course_id`))) join `question` on((`question`.`question_chapter_id` = `chapter`.`chapter_id`))) join `question_type` on((`question`.`question_type_id` = `question_type`.`question_type_id`)));
