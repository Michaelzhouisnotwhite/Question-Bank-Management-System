...
CREATE TABLE `examination`  (
  ...
  `course_id` int(0) NOT NULL,
  `examination_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
...
INSERT INTO `question` VALUES (34, 2, '2021-12-25 18:40:44', 1, 101);
...
-- ----------------------------
-- View structure for 查询课程对应题目类型
-- ----------------------------
DROP VIEW IF EXISTS `查询课程对应题目类型`;
